...
public class Mapping2Types{
	...
	{
		System.out.println("Mapping2Types Import Begin!" + "  Time : " + mat.format(new Date()));
		all = TypesVar.all;
		add(MapName);
		System.out.println("Mapping2Types  :  " + (all - TypesVar.all));
		TypesVar.all = all;
		System.out.println("Mapping2Types Import End!  " + "  Time : " + mat.format(new Date()));
	}
}