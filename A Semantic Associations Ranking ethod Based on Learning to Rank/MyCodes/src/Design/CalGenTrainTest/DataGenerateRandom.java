...
public class DataGenerateRandom {
	...
	private static Set<Integer> label = new HashSet<Integer>();
	...
	private static void WriteTest(Integer id)
	{
		...
		try {
			...
			if(sco[id] > 0)wta.write("1 0 ");else wta.write("0 1 ");
	...
	private static void UserGen(Integer userid)
	{
		...
		{
			tmpcnt --;
			Integer ss = (int)(Math.random() * 40.0);
			//System.out.println(ss);
			while(label.contains(ss)){ss = (int)(Math.random() * 30.0);}
			label.add(ss);
		}
